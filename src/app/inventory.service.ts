...
export class InventoryService {
  ...
  reviewAPIUrl =
    ...
    environment.devInventoryRoute +
    environment.devReviewRoute
  ...
  getInventory(inventoryId) {
    return this.http.get<Inventory>(
      this.inventoryAPIUrl + inventoryId,
      this.httpOptions,
    )
  }
  ...
  deleteReview(inventoryId, reviewId) {
    ...
    return this.http.delete(this.reviewAPIUrl + inventoryId + "/" + reviewId, this.httpOptions)
  }
}
